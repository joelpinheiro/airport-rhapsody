 ...
 *
 *  \brief Set of operations to manage the double-linked list of free inodes (linear FIFO) and the list of free
 *         data clusters: level 1 of the internal file system organization.
 *
