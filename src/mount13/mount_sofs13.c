/**
 *  \file mount_sofs13.c (implementation file)
 *
 *  \brief The SOFS13 mounting tool.
 *
 *  It provides a simple method to integrate the SOFS13 file system into Linux.
 *
 *  SINOPSIS:
 *  <P><PRE>                mount_sofs13 [OPTIONS] supp-file mount-point
 *
 *               OPTIONS:
 ...
 *  \author António Rui Borges - October 2010 / October 2013
 */
...
int main(int argc, char *argv[])
{
  ...
  char *fuse_argv[] = { argv[0], argv[optind+1],
                        /* "-s", */
                        "-o", "nonempty",
                        "-o", "fsname=SOFS13", "-o", "subtype=ext-like",
